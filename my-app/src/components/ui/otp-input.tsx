...
function AnimatedInputOTPSlot({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "data-[active=true]:border-ring data-[active=true]:ring-ring/50 data-[active=true]:aria-invalid:ring-destructive/20 dark:data-[active=true]:aria-invalid:ring-destructive/40 aria-invalid:border-destructive data-[active=true]:aria-invalid:border-destructive dark:bg-input/30 border-input relative flex h-12 w-12 items-center justify-center border-y border-r text-lg shadow-xs transition-all outline-none first:rounded-l-xl first:border-l last:rounded-r-xl data-[active=true]:z-10 data-[active=true]:ring-[3px]",
        className
      )}
    ...
    >
      ...
      {hasFakeCaret && (
        ...
        >
          <motion.div
            className="bg-blue-600 h-6 w-0.5"
